...
function toggleNotesSection(idx) {
  ...
  const label = content.closest('div')?.querySelector('.ex-notes-hide-btn');
...
function buildExerciseBlock(ex, idx) {
  ...
  metaBadgesHtml += `<span class="ex-meta-badge" style="cursor:pointer;color:${hasVideos ? 'var(--accent3)' : 'var(--text3)'}" onclick="openVideosModal(${idx})"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="vertical-align:middle;margin-right:3px"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>Videos</span>`;
  ...
  const notesHtml = `
    <div>
      <div class="ex-notes-label">Notes <span class="ex-notes-hide-btn" onclick="toggleNotesSection(${idx})">Hide</span></div>
