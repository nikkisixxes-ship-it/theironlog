...
function planOpenProfile(programId) {
  ...
  c.innerHTML = `
    ...
    <div style="padding:14px 16px 20px">
      ...
      ${p.notes ? `<div style="margin-bottom:6px"><div class="prof-section-label">Program Notes</div><div style="font-size:14px;color:var(--text2);line-height:1.6">${escapeHtml(p.notes).replace(/\n/g, '<br>')}</div></div>` : ''}
